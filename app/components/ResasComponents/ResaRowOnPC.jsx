...
import styles from './ResaRowOnPC.module.css';
import Image from 'next/image';

const ResaRowOnPC = (props) => {
  return (
    <div
    ...
    >
      ...
      <div className={styles.acompte}>{props.acompte} €</div>
      <div className={styles.commentaire}>{props.commentaire}</div>
      <div className={styles.table}>{props.table}</div>
    </div>
  );
};

export default ResaRowOnPC;
